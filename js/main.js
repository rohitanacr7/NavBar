...
//start form
document.addEventListener('DOMContentLoaded', function () {
  var myModal = new bootstrap.Modal(document.getElementById('quickCallModal'));
  myModal.show();
});
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (homeForm) {
    homeForm.addEventListener('submit', async function(event) {
      ...
      try {
        ...
        const response = await fetch('https://storyhumoremail.vercel.app/send-email-with-company', {
          method: 'POST',
          headers: {
        ...
        if (response.ok) {
          ...
          this.reset();
          // Close the modal
          const modal = bootstrap.Modal.getInstance(document.getElementById('quickCallModal'));
          if (modal) modal.hide();
        } else {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', async function(event) {
      ...
      try {
        // Send the data to the API
        const response = await fetch('https://storyhumoremail.vercel.app/send-email-with-referral', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
